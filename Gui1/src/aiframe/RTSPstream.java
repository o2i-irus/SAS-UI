...
public class RTSPstream{
  ...
  //public static IMediaListener mediaListener;
	...
	{   
	IMediaReader mediaReader = ToolFactory.makeReader("localhost:8888/ptzcamera");   //ptz raw 
	...
	IMediaReader mediaReader2 = ToolFactory.makeReader("localhost:8888/camera1");    //right raw
	...
	IMediaReader mediaReader3 = ToolFactory.makeReader("localhost:8888/camera2");   //front raw
	...
	IMediaReader mediaReader4 = ToolFactory.makeReader("localhost:8888/camera3");   //left raw
		...
		IMediaReader mediaReader5 = ToolFactory.makeReader("localhost:8888/camera4");   //back raw
     //	IMediaReader mediaReader5 = ToolFactory.makeReader("C:\\Users\\hp\\Downloads\\video\\radar1.mp4"); 
		...
		IMediaReader mediaReaderp = ToolFactory.makeReader("localhost:8888/ptzcameraprocessed");   //ptz processed 
		...
		IMediaReader mediaReader2p = ToolFactory.makeReader("localhost:8888/camera1processed");    //right processed
		...
		IMediaReader mediaReader3p = ToolFactory.makeReader("localhost:8888/camera2processed");    //right processed
		...
		IMediaReader mediaReader4p = ToolFactory.makeReader("localhost:8888/camera3processed");    //right processed
		...
		IMediaReader mediaReader5p = ToolFactory.makeReader("localhost:8888/camera4processed");    //right processed
