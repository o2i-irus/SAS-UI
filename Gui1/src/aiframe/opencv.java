...
public class opencv extends JPanel{
    public static JInternalFrame frame0;
    BufferedImage image;
    ...
    public opencv(BufferedImage img) {
        image = img;
    }   

    //Show image on window
    public void window(BufferedImage img, String text, int x, int y) {
        JInternalFrame frame0 = new JInternalFrame();
        frame0.getContentPane().add(new opencv(img));
        //frame0.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frame0.setBounds(381, 374, 352, 272);
        Frame.frame.getContentPane().add(frame0);
